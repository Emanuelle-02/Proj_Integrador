...
<html lang="en">
    <head>
        ...
        <title>IFRN-Lib. - Empréstimo/Devoluções</title>
                            ...
                            <div class="table-responsive">
                                ...
                                <br>
                                    <div class="widget-menu">
                                        <ul>
                                            <li><a href="emprestimos.php" class="request"><p>Solicitações de Empréstimo</p></a></li>
                                            <li><a href="renovacoes.php" class="request"><p>Solicitações de Renovação</p></a></li>
                                            <li><a href="devolucoes.php" class="request"><p>Solicitações de Devolução</p></a></li>
                                        </ul>
                                    </div>  
                                </div>
                            </div>
